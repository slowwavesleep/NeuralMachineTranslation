...
Видно, что при использовании описанной архитектуры качество растёт с увеличением количества обучающих примеров. Можно предположить,
...
результаты. Существуют также метрики, лучше оценивающими содержательную составляющую,как например`ESIM`, основанная
на эмбеддингах BERT. Весьма вероятно, что при оценке такими метриками, результаты модели будут заметно лучше.
